...
HitBox::HitBox(float &x, float &y, float &screenX, float &screenY, int &last_dir) : _atkActive(false), _x(x), _y(y), _screenX(screenX), _screenY(screenY), _last_dir(last_dir) {
